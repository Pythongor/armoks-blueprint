...
export const BiomeColorMap: Record<Biome, number> = {
  ...
  [Biome.FreshwaterTemperateMarsh]: 0x4682b4,
  [Biome.SaltwaterTemperateMarsh]: 0x4682b4,
  [Biome.FreshwaterTropicalMarsh]: 0x469ab4,
  [Biome.SaltwaterTropicalMarsh]: 0x469ab4,
